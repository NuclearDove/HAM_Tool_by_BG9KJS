...
import type { AppState, TabDef } from './types.js';
import { initData } from './core.js';
import { EventBus } from './event-bus.js';
import { showToast } from './ham-toast.js';

// Vue 3 API引用（延迟初始化）
let createApp: any, reactive: any, computed: any, onMounted: any, defineComponent: any;

// ============================================================
// 全局状态管理
// ============================================================
let appState: AppState = {} as AppState;
...
// 初始化Vue 3 API
// ============================================================
async function initVueApi(): Promise<void> {
...
// Vue应用创建与挂载
// ============================================================
export async function createHamApp(): Promise<any> {
  // 加载Vue 3 API
  await initVueApi();
  ...
  app.config.errorHandler = (err: any, vm: any, info: string) => {
    ...
    showToast('Vue错误: ' + (err as Error).message, 'error');
  };
